                              ...
                              Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child:  ElevatedButton(
                                        style: ButtonStyle(elevation: const MaterialStatePropertyAll(0),textStyle: MaterialStatePropertyAll(TextStyle(color: selectcontain == 1 ? Colors.white : Colors.black)),backgroundColor: MaterialStatePropertyAll(selectcontain == 1 ? notifier.theamcolorelight :  const Color(0xffD6C1F9)),shape: const MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(10))))),
                                        onPressed: () {
